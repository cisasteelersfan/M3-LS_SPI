...
void loop(){
    ...
    sendCommand(calibrate, 7);
    Serial.println("Starting Test!");
    delay(500);

    /* Procedure: Move to 2 mm; wait 1 second. Then, issue
    command to 4 mm and query motor position immediately
    to find when motor first moves.
    */
    sendCommand(twoMM, 14);
    delay(1000);
